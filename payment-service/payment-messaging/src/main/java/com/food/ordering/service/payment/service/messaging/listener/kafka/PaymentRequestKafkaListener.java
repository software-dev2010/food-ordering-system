package com.food.ordering.service.payment.service.messaging.listener.kafka;

import com.food.ordering.service.payment.service.messaging.mapper.PaymentMessagingDataMapper;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public void receive(
        ...
        log.info("{} number with payment requests received with keys: {}, partitions: {} and offsets: {}",
