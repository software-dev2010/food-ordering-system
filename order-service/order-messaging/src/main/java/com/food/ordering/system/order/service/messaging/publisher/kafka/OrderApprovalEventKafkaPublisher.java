...
public class OrderApprovalEventKafkaPublisher implements RestaurantApprovalRequestMessagePublisher {
    ...
    public void publish(
        ...
        OrderApprovalEventPayload orderApprovalEventPayload =
                kafkaMessageHelper.getOrderPaymentEventPayload(
        ...
        try {
            ...
            log.error("Error while sending OrderApprovalEventPayload sent to Kafka for order id: {} " +
                    "and saga id: {}, error: {}", orderApprovalEventPayload.getOrderId(), sagaId, e.getMessage());
        }
    }
}