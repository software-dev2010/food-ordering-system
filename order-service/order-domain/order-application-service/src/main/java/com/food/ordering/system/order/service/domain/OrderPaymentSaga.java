...
public class OrderPaymentSaga implements
        SagaStep<PaymentResponse, OrderPaidEvent, EmptyEvent> {

    private final OrderDomainService orderDomainService;
    private final OrderRepository orderRepository;
    private final OrderPaidRestaurantPaymentRequestMessagePublisher orderPaidRestaurantPaymentRequestMessagePublisher;
    ...
    public OrderPaidEvent process(PaymentResponse paymentResponse) {
        ...
        OrderPaidEvent domainEvent = orderDomainService.payOrder(
                order, orderPaidRestaurantPaymentRequestMessagePublisher);
