...
// @TestInstance with PER_CLASS option - to create a single instance of this test class, by default
// for each test method, a new instance of the class is created, in that case, to be able to use
// beforeAll method you need to use a static method, and to initialize the fields in this beforeAll
// method you need to use static for each field. I want to use beforeAll without static modifier
// and for that I use a single instance of this test class.
